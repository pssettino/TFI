...
Public Class DVH
    ...
    Public Sub RegistrarBitacora(evento As String, nivel As String, UsuarioBE As BE.Usuario, Optional noFueCalculadoDV As Boolean = True)
        Dim SeguridadBLL As New BLL.Seguridad
        Dim BitacoraBE As New BE.Bitacora
        BitacoraBE.Descripcion = SeguridadBLL.EncriptarRSA(evento)
        BitacoraBE.Usuario = UsuarioBE
        BitacoraBE.Criticidad = nivel
        BLL.Bitacora.GetInstance.RegistrarBitacora(BitacoraBE, noFueCalculadoDV)
    End Sub
